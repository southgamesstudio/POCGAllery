...
public class DummyControlUnit : MonoBehaviour
{
    ...
    //public void DoAdditem(DragAndDropItem item)
    //{
    ...
    //    FindObjectOfType<PhotonView>().RPC("DoAddItemSync", RpcTarget.AllBuffered,myString);
    //}

    //[PunRPC]
    //public void DoAddItemSync(string _JSONobject) 
    //{
    //    myItem = JsonUtility.FromJson<DragAndDropItem>(_JSONobject);
    //    DoAdditem(myItem);
    //}

    //private DragAndDropItem myItem;
